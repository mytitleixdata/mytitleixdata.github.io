...
console.log('is this happening?');
    ...
    if($('#NewHampshire').css('display') == 'block') {

        $('#NewHampshire1').highcharts({
            chart: {
        type: 'column'
    },
    title: {
        text: 'University of New Hampshire Clery Act Report Data'
    },
    subtitle: {
    ...
    series: [{
        name: 'University of New Hampshire Reports',
        colorByPoint: true,
        data: [{
            name: '2011',
            y: 21,
