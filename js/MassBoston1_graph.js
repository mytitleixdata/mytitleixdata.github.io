...
console.log('is this happening?');
    ...
    if($('#MassBoston').css('display') == 'block') {

        $('#MassBoston1').highcharts({
            chart: {
        type: 'column'
    },
    title: {
        text: 'University of Massachusetts-Boston Clery Act Report Data'
    },
    subtitle: {
    ...
    series: [{
        name: 'University of Massachusetts-Boston Reports',
        colorByPoint: true,
        data: [{
            name: '2011',
            y: 2,
