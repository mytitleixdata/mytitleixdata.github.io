...
console.log('is this happening?');
    ...
    if($('#MassAmherst').css('display') == 'block') {

        $('#MassAmherst1').highcharts({
            chart: {
        type: 'column'
    },
    title: {
        text: 'University of Massachusetts-Amherst Clery Act Report Data'
    },
    subtitle: {
    ...
    series: [{
        name: 'University of Massachusetts-Amherst Reports',
        colorByPoint: false,
        data: [{
            name: '2011',
            y: 13,
