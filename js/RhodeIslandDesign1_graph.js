...
console.log('is this happening?');
    ...
    if($('#RhodeIslandDesign').css('display') == 'block') {

        $('#RhodeIslandDesign1').highcharts({
            chart: {
        type: 'column'
    },
    title: {
        text: 'Rhode Island School of Design Clery Act Report Data'
    },
    subtitle: {
    ...
    series: [{
        name: 'Rhode Island School of Design Reports',
        colorByPoint: false,
        data: [{
            name: '2011',
            y: 0,
