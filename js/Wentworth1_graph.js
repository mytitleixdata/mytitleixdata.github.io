...
console.log('is this happening?');
    ...
    if($('#Wentworth').css('display') == 'block') {

        $('#Wentworth1').highcharts({
            chart: {
        type: 'column'
    },
    title: {
        text: 'Wentworth Institute of Technology Clery Act Report Data'
    },
    subtitle: {
    ...
    series: [{
        name: 'Wentworth Institute of Technology Reports',
        colorByPoint: false,
        data: [{
            name: '2011',
            y: 0,
